...
rem Launch the actual Unreal dedicated-server binary. DeceiveIncServer.exe is
rem the graphical configuration launcher and is intentionally bypassed.
set "INSTALL_ROOT=%~dp0"
set "SERVER_DIR=%INSTALL_ROOT%DeceiveInc\Binaries\Win64"
set "SERVER_EXE=%SERVER_DIR%\DeceiveIncServer-Win64-Shipping.exe"
set "SERVER_INI=%INSTALL_ROOT%DeceiveInc\Saved\Config\WindowsServer\TripwireServer.ini"
