...
`GUObjectArray` is recovered from the RIP-relative references generated by the
...
The suites cover native PE/signature discovery, configuration persistence and validation, the managed game-thread
